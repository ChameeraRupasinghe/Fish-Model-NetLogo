turtles-own [ age ]
breed [ fish a-fish ]
breed [ fish-bones a-fish-bone ]
breed [ fish-caught a-fish-caught]
...
to setup
  ...
  set-default-shape fish-caught   "fish"
  set num-fish-max 120
...
to catch-fish
  if any? fish[
    ask fish[
      if ycor < 0 [
        let x count fish with [ycor < 0]
        let catch-cap x * catch-coe / 100
...
true
15
Rectangle -7500403 true false 45 150 210 165
Line -7500403 false 75 135 105 195
Line -7500403 false 105 120 135 195
Line -7500403 false 135 105 165 210
Line -7500403 false 150 90 180 225
Line -7500403 false 185 100 195 205
Polygon -7500403 true false 210 150 195 135 225 92 270 105 285 150 285 165 240 180 285 195 225 210 210 165 210 165
Circle -16777216 true false 240 105 30
